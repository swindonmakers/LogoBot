/*
    ...
    This variant of LogoBot includes an IR distance sensor and "scanning" servo
...
machine("LogoBotIRSeeker.scad","LogoBot IR Seeker") {
...
## Introduction
\n
\nThe LogoBot IR Seeker build is broken down into sub-assemblies that can be worked on sequentially by one person, or in parallel if there is more than one person building.
\n
...
");
    //FakeGroundShadow()
        LogoBotIRSeekerAssembly(PenLift=true);
