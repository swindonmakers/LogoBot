...
4 | [No6 cs  wood screw x 20mm]() | ![](../vitamins/images/No6cswoodscrewx20mm_view.png) | 
...
52.1cm3, 0.07KG,  approx: 0.85 GBP
...
2. Push the capstan onto the motor shaft.  You can also add a retaining grub screw if necessary.
![](../assemblies/LogoBotPolarGraph/LeftCapstan_step2_view.png)
3. Slide the stepper driver into place and plug in the cable for the motor
...
1. Attach the pen lift
![](../assemblies/LogoBotPolarGraph/Gondola_step1_view.png)
2. Attach the three castors
![](../assemblies/LogoBotPolarGraph/Gondola_step2_view.png)
...
1. Cut a piece of wood to 500mm long, at least 20mm x 20mm cross section
![](../assemblies/LogoBotPolarGraph/LogoBotPolarGraph_step1_view.png)
2. Screw the capstan assemblies to the wooden beam, the axles should be 440mm apart.
![](../assemblies/LogoBotPolarGraph/LogoBotPolarGraph_step2_view.png)
3. String up the gondola using fishing line
![](../assemblies/LogoBotPolarGraph/LogoBotPolarGraph_step3_view.png)
10. Fix the arduino to the center of the beam - 200mm jumper wires should just reach from the motor drivers
![](../assemblies/LogoBotPolarGraph/LogoBotPolarGraph_step10_view.png)
20. Screw, tape or otherwise fix the polargraph onto the top of a suitable drawing surface - flipchart stands work well.
![](../assemblies/LogoBotPolarGraph/LogoBotPolarGraph_step20_view.png)
