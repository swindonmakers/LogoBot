...
#define LOGO_CMD_SIG		17  // signature
#define LOGO_CMD_WT			18  // write
#define LOGO_CMD_PQ			19  // print queue
#define LOGO_CMD_CS			20  // clear screen
#define LOGO_CMD_NL     21  // new line
